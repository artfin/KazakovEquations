...
Equations::Equations( unsigned int channels, unsigned int NPoints ) : channels(channels), NPoints(NPoints)
{
    // CO2-Ar
    //W.resize( 6 );
...
void Equations::reset_channels( const unsigned int channels )
{
