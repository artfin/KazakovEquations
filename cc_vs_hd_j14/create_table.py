...
with open("./tex/table.tex", "w") as out:
    ...
    out.write("\\begin{tabular}{cccccc}\n")
    out.write("\\toprule[1.5pt]\n")
    out.write("ODD & EVEN & M = 0 & M = 1 & M = 2 & M = 3\\\\ \n")
    out.write("\\midrule\n")
    ...
    for lvl in hd_lvls:
        ...
        if lvl_m == 1:
            out.write("{0:.4f} & {1:.4f} & & {2:.4f} & & \\\\ \n".format(closest_lvl["lvl"], closest_lvl2["lvl"], lvl_value))
